...
<button type="button" id="remove_'.$id.'" title="'.$this->field->getRemoveTitle().'."><i class="bi bi-trash"></i></button>
<button type="button" id="refresh_'.$id.'" title="'.$this->field->getRefreshTitle().'."><i class="bi bi-arrow-clockwise"></i></button>
